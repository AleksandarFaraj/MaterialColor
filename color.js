...
function Colors() {
    this.array = [red, pink, purple, deepPurple, indigo, blue, lightBlue, cyan, teal, green, lightGreen, lime, yellow, amber, orange, deepOrange];
}
...
Colors.prototype.getRandomAccent = function () {
    var color = this.getRandomColor();
    var accents = color.accent.colors;
    var index = getRandom(accents.length);
    var accent = accents[index];
    var light = false;
    if (index <= color.accent.light) {
        light = true;
    }
    return {
        name: color.name,
